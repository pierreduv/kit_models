...
class Message {
  ...
  int get hashCode =>
    ...
    (mediaId == null ? 0 : mediaId!.hashCode) +
  ...
  static Message? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Message(
        ...
        read: mapValueOfType<bool>(json, r'read') ?? false,
