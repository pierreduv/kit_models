...
class GroupList {
  ...
  @override
  String toString() => 'GroupList[items=$items, itemIds=$itemIds, next=$next]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GroupList[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GroupList[$key]" has a null value in JSON.');
        });
        return true;
      }());
