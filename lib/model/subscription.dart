...
class Subscription {
  ...
  bool operator ==(Object other) => identical(this, other) || other is Subscription &&
    ...
    other.activationsCount == activationsCount;
  ...
  int get hashCode =>
    ...
    (activationsCount == null ? 0 : activationsCount!.hashCode);

  @override
  String toString() => 'Subscription[startDate=$startDate, endDate=$endDate, activationsCount=$activationsCount]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.activationsCount != null) {
      json[r'activationsCount'] = this.activationsCount;
    } else {
      json[r'activationsCount'] = null;
    }
    return json;
  }
  ...
  static Subscription? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Subscription(
        ...
        activationsCount: mapValueOfType<int>(json, r'activationsCount'),
      );
    }
    return null;
  }
