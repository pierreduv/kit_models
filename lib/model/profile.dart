...
class Profile {
  ...
  bool operator ==(Object other) => identical(this, other) || other is Profile &&
    ...
    other.isGroupManager == isGroupManager &&
  ...
  int get hashCode =>
    ...
    (isGroupManager == null ? 0 : isGroupManager!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.isGroupManager != null) {
      json[r'isGroupManager'] = this.isGroupManager;
    } else {
      json[r'isGroupManager'] = null;
    }
  ...
  static Profile? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Profile(
        ...
        isGroupManager: mapValueOfType<bool>(json, r'isGroupManager'),
